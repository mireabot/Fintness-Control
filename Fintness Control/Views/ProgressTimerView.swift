...
class ProgressView: UIView {
    ...
    func drawProgress(with percent: CGFloat) {
        ...
        defaultCircleLayer.strokeColor = UIColor.line?.cgColor
        ...
        bigDotLayer.strokeColor = UIColor.primary?.cgColor
        ...
        (1...9).forEach { _ in
            ...
            ? UIColor.primary?.cgColor : UIColor.line?.cgColor
